...
@ccclass
export default class auto_doudouToMoneyRecord extends cc.Component {
	doudouToMoneyRecord: cc.Node;
	bg: cc.Node;
	header: cc.Node;
	btn_close: cc.Node;
	btn_close_1: cc.Node;
	...
	public static URL:string = "db://assets/resources/prefab/mine/doudouToMoneyRecord.prefab"

    onLoad () {
		this.doudouToMoneyRecord = this.node
		this.bg = this.doudouToMoneyRecord.getChildByName("bg");
