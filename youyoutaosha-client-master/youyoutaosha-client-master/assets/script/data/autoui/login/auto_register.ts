...
@ccclass
export default class auto_register extends cc.Component {
	register: cc.Node;
	bg: cc.Node;
	btnBack: cc.Node;
	...
	public static URL:string = "db://assets/resources/prefab/login/register.prefab"

    onLoad () {
		this.register = this.node
		this.bg = this.register.getChildByName("bg");
		this.btnBack = this.register.getChildByName("btnBack");
		this.icon_nav_return = this.btnBack.getChildByName("icon_nav_return");
		this.layout = this.register.getChildByName("layout");
		...
		this.btn_register = this.register.getChildByName("btn_register");
