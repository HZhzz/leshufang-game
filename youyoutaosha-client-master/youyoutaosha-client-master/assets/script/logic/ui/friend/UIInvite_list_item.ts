import auto_invite_list_item from "../../../data/autoui/friend/auto_invite_list_item";
...
@ccclass
@menu("UI/friend/UIInvite_list_item")
export default class UIInvite_list_item extends VirtualItem {
	ui: auto_invite_list_item = null;

	protected static prefabUrl = "friend/invite_list_item";
	protected static className = "UIInvite_list_item";
	vo: any;
	...
	onUILoad() {
		this.ui = this.node.addComponent(auto_invite_list_item);
	}
	...
	onClose() {
		UIHelp.CloseUI(UIInvite_list_item);
	}
}