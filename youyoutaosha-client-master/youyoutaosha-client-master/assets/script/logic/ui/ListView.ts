...
export class ListView extends cc.Component {
    ...
    public initView(view: cc.ScrollView, item: cc.Node, func: SetupCall) {
        ...
        this.view.content.on(cc.Node.EventType.POSITION_CHANGED, this.onRefreshView.bind(this));
...
export type SetupCall = (idx: number, node: cc.Node, forClean?: boolean) => boolean;