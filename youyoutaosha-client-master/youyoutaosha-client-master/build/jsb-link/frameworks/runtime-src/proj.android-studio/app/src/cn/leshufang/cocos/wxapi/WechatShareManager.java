...
public class WechatShareManager {
    ...
    public String WX_APP_ID = "wx97dfba2acdaa8400";
...
//        if (mWXApi == null) {
//            mWXApi = WXAPIFactory.createWXAPI(context, DeviceModule.WX_APPID, true);
//        }
//        mWXApi.registerApp(DeviceModule.WX_APPID);
//    }
...
//        Bitmap thumb = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.send_music_thumb);
        Bitmap thumb = BitmapFactory.decodeResource(mContext.getResources(), 100);
